  ...
  return (
    <div className="create-task-container">
      <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <>
            ...
            <div className="space-y-3">
              <label className="block text-sm font-semibold text-gray-700">
                ...
                <span className="text-xs text-gray-500 font-normal">
                  ({formData.approverIds.length} selected)
                </span>
              </label>
                      ...
                      <div className="flex items-center space-x-3">
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center space-x-2">
                            <input
                              type="checkbox"
                              checked={formData.approverIds.includes(
                                approver.id,
                              )}
            ...
            <div className="grid grid-cols-3 sm:grid-cols-2 md:grid-cols-3 gap-6">
              ...
              <div className="space-y-2">
                ...
                <div
                  className={`inline-block px-2 py-1 rounded-full text-xs font-medium border ${getPriorityColor(formData.priority)}`}
                >
              ...
              {formData.autoApproveEnabled && (
                <div className="ml-7 p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
                  ...
                  <p className="text-xs text-yellow-700 mt-2">
                    Auto-approve if no response after due date + X days
                  </p>
                </div>
              )}
            </div>
        ...
        {/* Form Actions */}
        <div className="flex flex-col sm:flex-row gap-3 sm:justify-between pt-6 border-t border-gray-200">
