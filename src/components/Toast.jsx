...
export default function Toast({ message, type = 'success', isVisible, onClose, duration = 3000 }) {
  ...
  const getToastStyles = () => {
    const baseStyles = "fixed top-6 left-1/2 transform -translate-x-1/2 z-[9999] px-6 py-4 rounded-lg shadow-lg flex items-center gap-3 transition-all duration-300 ease-in-out";
