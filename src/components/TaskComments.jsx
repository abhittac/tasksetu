  ...
  const [comments, setComments] = useState([
    {
      ...
      user: 'John Smith',
      avatar: 'JS',
      text: 'The database backup has been completed successfully. Ready to proceed with the next phase.',
      time: '2 hours ago'
    },
    {
      id: 2,
      user: 'Sarah Wilson',
      avatar: 'SW',
      text: 'Great work! I\'ve started working on the migration scripts. Should have them ready by tomorrow.',
      time: '1 hour ago'
    }
  ])
