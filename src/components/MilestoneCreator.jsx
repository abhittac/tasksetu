        ...
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            ...
            <p className="text-sm text-gray-600">
              Define the basic properties and configuration for your milestone
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="grid grid-cols-3 md:grid-cols-2 gap-4">
          <div className="form-group">
            ...
            <select
              ...
              onChange={(e) =>
                handleInputChange("milestoneType", e.target.value)
              }
            ...
            <div className="bg-gradient-to-br from-indigo-50 to-blue-50 border border-indigo-200 rounded-xl p-4">
              <div className="space-y-3">
                {availableTasks.map((task) => (
                  <label
                    key={task.id}
                    className="flex items-center space-x-3 p-3 bg-white rounded-lg border border-gray-200 hover:border-indigo-300 hover:bg-indigo-50 transition-all duration-200 cursor-pointer group"
                  >
                    <input
                      type="checkbox"
            ...
            <div className="space-y-3">
              {teamMembers
                ...
                .map((member) => (
                  <label
                    key={member.id}
                    className="flex items-center space-x-3 p-3 bg-white rounded-lg border border-gray-200 hover:border-teal-300 hover:bg-teal-50 transition-all duration-200 cursor-pointer group"
                  >
                    <input
                      type="checkbox"
