      ...
      approvers: [
        {
          ...
          role: "security",
          status: "approved",
          comment: "Security measures adequate",
        ...
        },
        {
          ...
          role: "legal",
          status: "rejected",
          comment: "Need additional clauses",
    ...
    <>
      <div className="card hover:shadow-lg transition-shadow duration-200">
        <div className="flex items-start justify-between mb-4">
          ...
          <span
            className={`status-badge ${overallStatus === "approved" ? "status-completed" : overallStatus === "rejected" ? "bg-red-100 text-red-800" : overallStatus === "pending" ? "status-progress" : "status-todo"}`}
          >
