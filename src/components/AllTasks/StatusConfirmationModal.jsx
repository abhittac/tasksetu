...
export default function StatusConfirmationModal({ taskTitle, statusLabel, onConfirm, onCancel }) {
  return (
        ...
        <div className="p-6">
          ...
          <div className="mb-6">
            <p className="text-gray-900 mb-2">
              Are you sure you want to mark this task as <strong>{statusLabel}</strong>?
            </p>
